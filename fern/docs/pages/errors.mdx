...
| `409` | Conflict with an existing record, or a lookup that matched more than one | Read `details.candidate` and choose one |
...
`409`, `415`, or `422` — the same request will fail the same way.
